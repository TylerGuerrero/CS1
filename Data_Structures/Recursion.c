...
int super_fancy_min_array(int *array, int n)
{
  return ((n == 1) ? array[0] : min(array[0], super_fancy_min_array(array + 1, n - 1)));
}
...
int find_max_array(int *array, int n)
{
  ...
  return min(array[n - 1], find_max_array(array, n - 1));
}
...
{
  return ((n == 1) ? array[0] : max(array[n - 1], super_fancy_max_array(array, n - 1)));
}
